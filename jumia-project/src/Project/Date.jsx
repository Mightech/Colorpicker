...
import { validateDay, validateMonth, validateYear } from "../Project/utils/validate.js";
import IconSubmit from'./Submit.jsx';

// function
import { calculateAge } from "../Project/utils/calculateAge.js";
const Date = ({ onAge }) => {
